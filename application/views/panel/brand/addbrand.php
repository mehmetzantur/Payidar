    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
				...
				<form class="form-horizontal" action=<?php echo base_url(). 'Panel/Brand/Add'; ?> method="post" enctype="multipart/form-data">
                    ...
                    <fieldset id="account">
                        ...
                        <div class="form-group required">
                            <div class="col-sm-12">
                                ...
                                <input type="text" class="form-control" id="input-lastname" placeholder="Marka Adı" value="<?php echo set_value('name'); ?>" name="name">
                            </div>
                        </div>
                        <div class="form-group required">
                            <div class="col-sm-12">
